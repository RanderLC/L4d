...
public class FrmManteProd extends JFrame {
	...
	void registrar() {
		...
		double pre_pro = Double.parseDouble(txtPrecio.getText());
		int idcategorias = cboCategorias.getSelectedIndex();
		int est_pro = 1;
	...
	void aviso(String algo) {
		JOptionPane.showMessageDialog(this, algo, "Aviso de sistema", 
